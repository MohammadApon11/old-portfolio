            ...
            <div className="text-white" data-aos="fade-left">
                <div className="mt-4">
                    ...
                    <div className="flex lg:gap-5 gap-2">
                        <a href="https://toy-house-open.web.app/" className="bg-[#28e98c] lg:w-auto text-center w-1/3 py-1 lg:px-4 font-semibold hover:bg-white lg:py-2 hover:text-[#28e98c] hover:scale-105 duration-100">Live Site</a>
                        <a href="https://github.com/A2N426/online-shopping-client" className="bg-[#28e98c] lg:w-auto text-center w-1/3 py-1 lg:px-4 font-semibold hover:bg-white lg:py-2 hover:text-[#28e98c] hover:scale-105 duration-100">Github Client</a>
                        <a href="https://github.com/A2N426/online-shopping-server" className="bg-[#28e98c] lg:w-auto text-center w-1/3 py-1 lg:px-4 font-semibold hover:bg-white lg:py-2 hover:text-[#28e98c] hover:scale-105 duration-100">Github Server</a>
                    </div>
                </div>
            </div>
        </div>
